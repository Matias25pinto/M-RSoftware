...
<div class="row">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<h3>Facturas de Compras <a href="ingreso/create"><button class="btn btn-success">Nuevo</button></a> <a href="{{url('reporteingresos')}}"><button class="btn btn-info">Reporte</button></a></h3>
